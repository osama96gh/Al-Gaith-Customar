...
public class LoginActivity extends AppCompatActivity {
    ...
    public void goSineUp(View view) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            Log.println(Log.ASSERT, "event", "try login");
            String response = GeneralUtility.logIn(LoginActivity.this, mEmail, mPassword);
            return response;
        }
        ...
        protected void onPostExecute(final String response) {
            ...
            if (response.matches("no error")) {
                Intent intent = new Intent(LoginActivity.this, SplachActivity.class);
                startActivity(intent);
                finish();
